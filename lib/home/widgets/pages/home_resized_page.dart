...
class HomeResizedPage extends StatefulWidget {
  final HomeController controller;
  const HomeResizedPage({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<HomeResizedPage> createState() => _HomeResizedPageState();
}

class _HomeResizedPageState extends State<HomeResizedPage> {
  @override
  void initState() {
